...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{route("provide.create")}}" class="btn btn-primary mb-2" style="float:right;">Add Provide</a>
                </div>
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="card-title">Provide List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
    ...
    <script>
        ...
        function statusChanges(id) {
            let status = $('#status-' + id).find(":selected").val()
                $.ajax({
                    type:'GET',
                    url:"{{ route('provide-status-change') }}",
                    data:{
                        id:id,
                        status:status
                    },
        ...
        function deleteItem(id) {
            ...
            var url = '{{ route("provide.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
