...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{route("hire.create")}}" class="btn btn-primary mb-2" style="float:right;">Add hire</a>
                </div>
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="card-title">Hires List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
